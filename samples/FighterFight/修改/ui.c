...
#define COLOR_BULLET	RGB(0,255,0)//绿色
#define COLOR_ENEMY		RGB(255,0,255)//紫色
#define COLOR_BOMB		RGB(255, 0, 0)//红色
...
HWND BackgroundWindowCreate(HINSTANCE hinstance)
{
	...
	// 显示窗口，WinMain函数的nCmdhow参数在这里发挥作用，一般都设置为SW_SHOW
